...
export default async function FacturesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Factures classées"
        description="L'agent IA détecte les factures PDF reçues par mail, extrait date / fournisseur / prestation et les range automatiquement dans Drive (Parade/YYYY/Fournisseur/AAMMJJ_facture_*.pdf)."
      />
